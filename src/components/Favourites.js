        ...
        favouriteRooms: [
            {
                ...
                description: 'Set in Destin in the Florida region, 2 Bed 2 Bath Apartment in Miramar Beach features a patio.',
                price: '$1,900.00 ',
				priceTail: '/ month',
				review: '4/5 stars ',
            ...
            <div className="outer-container">
				...
				<div className="fav-container">
					{this.state.favouriteRooms.map((item, index) => {
						return (
							<div onClick={(e) => this.viewDetail(e, item.id)} key={index} className="card-container-fav">

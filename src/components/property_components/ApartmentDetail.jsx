...
class ApartmentDetail extends Component {
  ...
  render() {
    ...
    // let ratingView = this.state.ratingDetails;
    // if(ratingView !== null || ratingView !== '' || ratingView === "undefined"){
    //   console.log("View data available ", typeof(ratingView));
    // }
    // else{
    //   console.log("view data unavailable ", ratingView);
    // }
                ...
                <section className="room-extras">
                  ...
                  <ul className="amenities">
                    {this.state.apartmentDetails.amenities.map((item, index) => {
                      return <li key={index}><i className="fa fa-building-o" aria-hidden="true"/> {item}</li>;
                    })}
                  </ul>
                </section>
                <section className="room-extras">
                    ...
                    <div className="rating-two">
                      <div className="rating-three">
                        ...
                        <div className="rating-five">
                          <div className="rating-six" aria-label="4.6 out of 5.0" role="img"><span className="_1wsvxly" style={({ width: this.state.ratingDetails.cleanliness*100/5+"%"})}></span></div>
                          <span className="rating-seven" aria-hidden="true">{this.state.ratingDetails.cleanliness}</span></div>
                      </div>
                    </div>
                  </div>
                  <div className="rating-one">
                    <div className="rating-two">
                      <div className="rating-three">
                        ...
                        <div className="rating-five">
                          <div className="rating-six" aria-label="4.6 out of 5.0" role="img"><span className="_1wsvxly" style={({ width: this.state.ratingDetails.cleanliness*100/5+"%"})}></span></div>
                          <span className="rating-seven" aria-hidden="true">{this.state.ratingDetails.communication}</span></div>
                      </div>
                    </div>
                  </div>
                  <div className="rating-one">
                    <div className="rating-two">
                      <div className="rating-three">
                        ...
                        <div className="rating-five">
                          <div className="rating-six" aria-label="4.6 out of 5.0" role="img"><span className="_1wsvxly" style={({ width: this.state.ratingDetails.cleanliness*100/5+"%"})}></span></div>
                          <span className="rating-seven" aria-hidden="true">{this.state.ratingDetails.accuracy}</span></div>
                      </div>
                    </div>
                  </div>
                  <div className="rating-one">
                    <div className="rating-two">
                      <div className="rating-three">
                        ...
                        <div className="rating-five">
                          <div className="rating-six" aria-label="4.6 out of 5.0" role="img"><span className="_1wsvxly" style={({ width: this.state.ratingDetails.cleanliness*100/5+"%"})}></span></div>
                          <span className="rating-seven" aria-hidden="true">{this.state.ratingDetails.location}</span></div>
                      </div>
                    </div>
                  </div>
                </section>

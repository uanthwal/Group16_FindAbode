		...
		return (
			<div>
				<div
					...
					className={this.state.showBlurBg ? 'home-comp-container blur-bg' : 'home-comp-container'}
				>
									...
									<div className="grid-item" key={element.id}>
										<div className="img-blck">
											<img
												alt={element.name}
												src={
													'https://r-cf.bstatic.com/images/hotel/max1280x900/168/168547469.jpg'
												}
											/>
										</div>
										<div className="cntnt-blck">
											...
											<span className="place-book">
												<button onClick={this.onClickExplorePlace.bind(this)}>EXPLORE</button>
											</span>
										</div>
									</div>
								))}
